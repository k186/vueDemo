  ...
  <transition name="datePicer-Toggle">
    <div class="k-datePicker" v-if="visible">
      <div class="datePane">
          ...
          <div class="yearBox" key="day"  v-show="panelType =='day'">
            <ul>
              ...
              <li class="Title" v-on:click="changeType('month')">
                <transition-group name='change-Tiltle' class='changeTitle' tag="div">
                  <span v-bind:key="tmpYear">{{tmpYear}}</span>
                </transition-group>
                <transition-group name='change-Tiltle' class='changeTitle' tag="div">
                  <span v-bind:key="tmpMonth">{{monthList[tmpMonth]|monthF(language)}}</span>
                </transition-group>
          ...
          <div class="yearBox" key="month" v-show="panelType =='month'">
            <ul>
              ...
              <li class="Title" v-show="panelType =='month'" v-on:click="changeType('year')">
                <transition-group name='change-Tiltle' tag="div" class='changeYearTitle'>
                  <span v-bind:key="tmpYear">{{tmpYear}}</span>
                </transition-group>
              </li>
        ...
        <transition-group name="change-panel" class="chooseBox" tag='div'>
          ...
          <div class="chooseDay" key='day' v-show="panelType=='day'">
            ...
            <transition-group name='change-Month' class="change-Month-Box" tag="div">
