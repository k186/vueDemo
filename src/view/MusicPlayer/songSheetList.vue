      ...
      <div class="song-sheet-list-box scroller" id="song-SheetList-scroller">
        <div class="song-sheet-list-head">
          ...
          <div class="song-sheet-list-head-btn">
            <div class="song-sheet-btns">
              <div class="icon song-sheet-list-head-btn-add">&#xe625;</div>
              <div>添加</div>
            </div>
            <div class="song-sheet-btns">
              <div class="icon song-sheet-list-head-btn-manage">&#xe601;</div>
              <div>管理</div>
            </div>
          </div>
        </div>
        <single-sheet :listData="userData.basicInfo.SheetList.list" from="sheet"></single-sheet>
      </div>
    </div>
  </div>
</template>
  ...
  export default{
    ...
    mounted () {
      if (this.userData.basicInfo.SheetList.list.length !== 0) {
        let that = this
        publicJs.initScroll({
          wrapper: 'song-SheetList-wrapper',
          scroller: 'song-SheetList-scroller',
